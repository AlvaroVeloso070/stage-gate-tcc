...
function UITreeNode_Conditional_0_li_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext(2);
    ɵɵclassMap(ctx_r2.cx("dropPoint", ɵɵpureFunction1(3, _c1, ctx_r2.draghoverPrev)));
...
function UITreeNode_Conditional_0_span_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵclassMap(ctx_r2.cx("nodeToggleIcon"));
    ɵɵadvance();
    ɵɵproperty("ngTemplateOutlet", ctx_r2.tree.togglerIconTemplate || ctx_r2.tree._togglerIconTemplate)("ngTemplateOutletContext", ɵɵpureFunction2(4, _c2, ctx_r2.node.expanded, ctx_r2.node.loading));
  }
}
...
function UITreeNode_Conditional_0_p_checkbox_6_ng_container_1_ng_template_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext(4);
    ɵɵproperty("ngTemplateOutlet", ctx_r2.tree.checkboxIconTemplate || ctx_r2.tree._checkboxIconTemplate)("ngTemplateOutletContext", ɵɵpureFunction3(2, _c3, ctx_r2.isSelected(), ctx_r2.node.partialSelected, ctx_r2.cx("nodeCheckbox")));
  }
}
...
function UITreeNode_Conditional_0_li_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r2 = ɵɵnextContext(2);
    ɵɵclassMap(ctx_r2.cx("dropPoint", ɵɵpureFunction1(3, _c1, ctx_r2.draghoverNext)));
    ɵɵattribute("aria-hidden", true);
  }
}
function UITreeNode_Conditional_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngStyle", ɵɵpureFunction1(33, _c0, ctx_r2.itemSize + "px"));
...
function Tree_ng_container_4_p_scroller_1_ng_container_4_ng_template_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngTemplateOutlet", ctx_r0.loaderTemplate || ctx_r0._loaderTemplate)("ngTemplateOutletContext", ɵɵpureFunction1(2, _c18, scrollerOptions_r11));
  }
}
...
function Tree_ng_container_4_p_scroller_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const ctx_r0 = ɵɵnextContext(2);
    ɵɵstyleMap(ɵɵpureFunction1(10, _c0, ctx_r0.scrollHeight !== "flex" ? ctx_r0.scrollHeight : void 0));
...
var UITreeNode = class _UITreeNode extends BaseComponent {
  ...
  setAllNodesTabIndexes() {
    const nodes = Y2(this.tree.el.nativeElement, ".p-tree-node");
  ...
  setTabIndexForSelectionMode(event, nodeTouched) {
    if (this.tree.selectionMode !== null) {
      const elements = [...Y2(this.tree.el.nativeElement, '[role="treeitem"]')];
...
var Tree = class _Tree extends BaseComponent {
  ...
  _filter(value) {
    ...
    if (filterValue === "") {
      ...
      const filterText = Y(filterValue).toLocaleLowerCase(this.filterLocale);
  ...
  isFilterMatched(node, params) {
    ...
    for (let field of searchFields) {
      let fieldValue = Y(String(c(node, field))).toLocaleLowerCase(this.filterLocale);
...
//# sourceMappingURL=chunk-4DY4PHPO.js.map
